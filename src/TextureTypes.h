...
public:
    ...
    inline static constexpr const char* METAL_HEIGHT = "BRICKS_HEIGHT";
    ...
    inline static constexpr const char* BRICKS_HEIGHT = "BRICKS_HEIGHT";
    ...
    static const std::vector<const char*>& GetAllTextures()
    {
        static const std::vector<const char*> textures = {
            ...
            BRICKS_COLOR, BRICKS_NORMAL, BRICKS_ROUGH, BRICKS_AO, BRICKS_HEIGHT,
            DEFAULT,
        };
        return textures;
    }
